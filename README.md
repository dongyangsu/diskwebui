...
├── CHANGELOG.md              # 版本更新记录（每个版本相对上一版的 增加/修改/删除）
...
**每个版本相对上一版"增加了什么 / 修改了什么 / 删除了什么"，见 [CHANGELOG.md](CHANGELOG.md)。**
...
版本变更记录：[CHANGELOG.md](CHANGELOG.md)　|　版本归档：[versions/README.md](versions/README.md)
