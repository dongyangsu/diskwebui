...
**当前版本：v3.0**（每个版本逐条对照的「新增了 / 修复了 / 优化了 / 删除了」见 [更新修复及优化一览（CHANGELOG.md）](CHANGELOG.md)）
...
- 参与条件：本机需 Node.js ≥ 18 与 Chrome（无头即可）
...
- **文档**：新增《更新修复及优化一览》（[CHANGELOG.md](CHANGELOG.md)）；README 补充设备要求、终端适配与部署说明
